...
namespace Google.Maps.Examples {
    ...
    public class BasicExample1 : MonoBehaviour {
        [Tooltip("LatLng to load (must be set before hitting play).")]
        private LatLng _latLng = new LatLng(37.539620, 127.123673);

        private MapsService _mapsService;

        private KJS_BuildingManager _buildingManager;
        ...
        private void Start() {
            ...
            _buildingManager = GetComponent<KJS_BuildingManager>();
