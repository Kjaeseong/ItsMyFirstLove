Shader "Hidden/lilToonOutline"
{
    Properties
    {
        ...
        [Enum((Equal, 3, NotEqual, 6))]                 _StencilComp        ("Stencil Compare Function", int) = 8
        ...
        [Enum((Equal, 3, NotEqual, 6))]                 _OutlineStencilComp         ("Stencil Compare Function", int) = 8
        [Enum(UnityEngine.Rendering.StencilOp)]         _OutlineStencilPass         ("Stencil Pass", Float) = 0
        [Enum(UnityEngine.Rendering.StencilOp)]         _OutlineStencilFail         ("Stencil Fail", Float) = 0ten
